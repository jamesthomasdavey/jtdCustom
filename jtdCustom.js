...
const bestPractices = [
  ...
  },
  {
    ...
    scenario: 'There is no skip link to circumvent navigation',
    codesnippet:
  ...
  },
  {
    ...
    media: 'Web',
    bestpractice: 'Provide alternative text for images',
    scenario: 'Decorative images lack null alt text and are revealed to assistive technology',
    codesnippet:
  ...
  },
  {
    ...
    issuedescription:
      '[Recommendation]\nDevelopers must ensure that screen readers do not perceive the same information twice by adding a null alt attribute to the image, and removing the link from the focus order with a tabindex="-1" attribute.\n\n[Code Sample]\n_____'
  },
  {
    violationid: 387,
    media: 'Web',
  ...
  },
  {
    ...
    bestpractice:
      'Ensure all active elements receive keyboard focus or can be activated with the keyboard',
    scenario:
      'Interactive generic element does not receive keyboard focus and cannot be activated with the keyboard',
    codesnippet:
  ...
  },
  {
    ...
    bestpractice:
      'Ensure all active elements receive keyboard focus or can be activated with the keyboard',
    scenario:
      'Interactive generic element does not receive keyboard focus but could be activated by keyboard',
    codesnippet:
  ...
  },
  {
    ...
    media: 'Web',
    bestpractice: 'Ensure custom controls provide proper textual name, role, and state information',
    scenario: '<button> elements or elements with role="button" do not have a proper textual name',
    codesnippet:
  ...
  },
  {
    ...
    media: 'Web',
    bestpractice: 'Ensure custom controls provide proper textual name, role, and state information',
    scenario: '<a> element is used as a button and has an implicit role of "link"',
    codesnippet:
  ...
  },
  {
    ...
    bestpractice: 'Ensure sufficient contrast is provided when background images are not available',
    scenario:
      'Text between 14pt and 18pt has insufficient contrast when background image is disabled',
    codesnippet:
  ...
  },
  {
    ...
    media: 'Web',
    bestpractice: 'Ensure all interactive functionality is operable with the keyboard',
    scenario: 'Interactive elements only become visible during mouse-over'
  }
];
...
const init = () => {
  ...
  const patternText = isPattern
    ? `[Pattern: ${bestPracticeSelectList.parentNode.parentNode.previousSibling.firstElementChild.firstElementChild.textContent.substring(
        18
      )}]${'\n\n'}`
    : '';
  ...
  const fillInputs = e => {
    ...
    const chosenBestPractice = bestPractices.find(
      bestPractice => bestPractice.scenario === specificListValue
    );
  ...
  const insertPatternText = e => {
    ...
    const replacementText =
      issueIndex !== -1 ? codeSnippetTextArea.value.substr(issueIndex) : codeSnippetTextArea.value;
    codeSnippetTextArea.value = patternText;
  ...
  bestPracticeSelectList.addEventListener('change', e => {
    const violations = bestPractices.filter(
