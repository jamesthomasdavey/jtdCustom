...
const bestPractices = [{
  ...
  },
  {
    ...
    "codesnippet": "[Issue]\nThe _____ spans multiple lines and is not contained in a <blockquote> element.\n\n[Impact]\nBy using the <blockquote> element, assistive technology will convey the fact that its content appears within the context of a quote.\n\n[Code Sample]\n_____",
    "issuedescription": "[Recommendation]\nEnsure that the quote content is nested in a <blockquote> element.\n\n[Code Sample]\n_____"
  },
  {
    "violationid": 490,
    "media": "Web",
  ...
  },
  {
    "violationid": 2338,
    "media": "Android",
    "bestpractice": "Provide section headings to organize content",
    "scenario": "Implicit headings are used"
  },
  {
    "violationid": 2426,
    "media": "Web",
